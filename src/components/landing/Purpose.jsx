        ...
        <div className="rounded-3xl p-8 sm:p-12 text-white max-w-3xl mx-auto" style={{ background: 'linear-gradient(to bottom right, #581c87, #9333ea)' }}>
          <div>
            ...
            <p className="text-purple-100 text-lg leading-relaxed mb-6">
              SafeWays is not the solution to this problem, only systemic change can be. But while change happens, we want to empower women and anyone who uses our app to walk their city with confidence, knowing their route has been planned with safety in mind, not just speed.
            </p>
            <p className="text-purple-200 text-base leading-relaxed italic">
              Because everyone should enjoy their city freely, and until the world catches up, we'll try our best to help you make informed decisions of your walking route.
            </p>
          </div>
        </div>
