...
const featureColors = ['from-purple-600 to-purple-700', 'from-orange-500 to-orange-600', 'from-yellow-500 to-orange-500', 'from-purple-600 to-pink-600', 'from-red-500 to-orange-600', 'from-blue-500 to-purple-600'];
const featureKeys = [['feat1_title', 'feat1_desc'], ['feat2_title', 'feat2_desc'], ['feat3_title', 'feat3_desc'], ['feat4_title', 'feat4_desc'], ['feat5_title', 'feat5_desc'], ['feat6_title', 'feat6_desc']];
    ...
    <div className="py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {featureKeys.map(([titleKey, descKey], index) => (
            <div 
              key={index} 
              className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all hover:-translate-y-1 border border-gray-100"
            >
              <div className={`w-16 h-16 bg-gradient-to-br ${featureColors[index]} rounded-xl flex items-center justify-center text-white mb-6 shadow-lg`}>
                {featureIcons[index]}
              </div>
